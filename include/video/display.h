 ...
 *  <at> DISPLAY_ENTITY_STREAM_STOPPED: The video stream is stopped, no frames are
 *	transferred.
 *  <at> DISPLAY_ENTITY_STREAM_SINGLE_SHOT: The video stream has been started for
 *      single shot operation. The source entity will transfer a single frame
 *      and then stop.
 *  <at> DISPLAY_ENTITY_STREAM_CONTINUOUS: The video stream is running, frames are
